...
#'   \item{PA_1_2_1_daytime_mean}{Numeric. Mean atmospheric pressure during daytime, retrieved from lowest tower level (2 m) (kPa).}
#'   \item{TA_1_2_1_daytime_mean}{Numeric. Mean air temperature during daytime, retrieved from lowest tower level (2 m) (°C).}
#'   \item{TA_1_7_1_daytime_mean}{Numeric. Mean air temperature during daytime, retrieved from highest tower level (28 m) (°C).}
#'
#'   \item{RH_1_2_1_daytime_mean}{Numeric. Mean relative humidity at lowest tower level (2 m) during daytime ().}
#'   \item{RH_1_7_1_daytime_mean}{Numeric. Mean relative humidity at highest tower level (28 m) during daytime ().}
#'
#'   \item{SWC_4_1_1_daytime_mean}{Numeric. Mean soil water content at location 2, shallowest sensor (m³/m³).}
#'   \item{SWC_4_2_1_daytime_mean}{Numeric. Mean soil water content at location 2, intermediate sensor (m³/m³).}
...
#'
#'   \item{daytime_hours}{Numeric. Total daylight hours, calculated using the astral Python package (hours).}
...
#'
#'   \item{SW_IN_daytime_sum}{Numeric. Incoming shortwave radiation summed over daytime (W/m²/day).}
#'
...
#'
#'   \item{blc_flag}{Integer/Logical. Boundary layer coupling state (0 = no BLC, 1 = clean BLC, 2 = non-ideal BLC).}
#'   \item{Conditions}{Integer. Daily boundary layer condition classification:
#'     0 = clear sky,
#'     1 = morning clear → afternoon shallow cumulus,
#'     2 = stratiform/overcast,
#'     3 = morning overcast → afternoon shallow cumulus,
#'     4 = synoptic (rain/snow/fog),
#'     5 = synoptic → afternoon shallow cumulus.}
#'   \item{Smoke}{Integer/Binary. Presence of smoke/aerosols (1 = yes, 0 = no).}
#'
#'   \item{LCL_height_km}{Numeric. Lifting condensation level from Caribou soundings (km).}
#'   \item{LTS_K}{Numeric. Lower tropospheric stability (Δθ between surface and 700 hPa) (K).}
#'   \item{LapseRate_850_500_CperKm}{Numeric. Lapse rate between 850–500 hPa (°C/km).}
#'   \item{PW_mm}{Numeric. Precipitable water (mm).}
#'
#'   \item{mean_cf_2_6}{Numeric. Mean cloud fraction (14:00–18:00 LST), range 0–1.}
#'   \item{std_cf_2_6}{Numeric. Standard deviation of cloud fraction (14:00–18:00 LST).}
#'   \item{cv_cf_2_6}{Numeric. Coefficient of variation of cloud fraction (14:00–18:00 LST).}
#'
#'   \item{mean_cbh_2_6}{Numeric. Mean cloud base height (14:00–18:00 LST) (m).}
#'   \item{std_cbh_2_6}{Numeric. Standard deviation of cloud base height (m).}
#'
#'   \item{morning_cbh}{Numeric. Mean cloud base height (08:00–11:00 LST) (m).}
#'   \item{evening_cbh}{Numeric. Mean cloud base height (16:00–19:00 LST) (m).}
#'   \item{cbh_rise}{Numeric. Change in cloud base height from morning to evening (m).}
#'   \item{cbh_rise_filtered}{Numeric. Quality-controlled CBH rise (BLC-only days) (m).}
#'
#'   \item{mean_LCL_4_7}{Numeric. Mean LCL (04:00–07:00 LST) from tower-derived calculations (m).}
#'
#' @details
